...
SUBROUTINE TMMultLieb2DAtoB1(PSI_A,PSI_B, Ilayer, En, DiagDis, LiebDis, CubeConPot, LiebConPot, M )
...
SUBROUTINE TMMultLieb2DB2toA(PSI_A,PSI_B, Ilayer, En, DiagDis, LiebDis, CubeConPot, LiebConPot, M )
...
SUBROUTINE TMMultLieb2DB1toB2(PSI_A,PSI_B, Ilayer, En, DiagDis, LiebDis, CubeConPot, LiebConPot, M )
...
!  USE DPara
  ...
  CALL TMMultLieb2DB2toA(PSI_A,PSI_B, Ilayer, En, DiagDis, LiebDis, CubeConPot, LiebConPot, M )
